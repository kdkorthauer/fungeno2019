...
Let's start with a very simple example, where we have two groups (goverened by $x$), each with a different probability of success. 
...
This link function is similar to the logit in that it transforms a (0,1) quantity to the real line, but the transformation is less drastic in the extremes.
