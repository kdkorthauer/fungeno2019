...
- count reads per transcript/gene - bulk tools widely used (e.g. Subread), specialized tools available (e.g. [Alevin](https://doi.org/10.1186/s13059-019-1670-y) for droplet data)
